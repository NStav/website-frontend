    ...
    <div>
      <div className="ExerciseBackground">
        ...
        <div className="ProjectGrid">
          <div className="ProjectObject"><h1>Project 1</h1><p>Project Sun Cycle</p>< img src = {sun} alt="RunningIcon"/></div>
          <div className="ProjectObject"><h1>Project 2</h1><p>Run With the Drawing</p>< img src = {maps} alt="YogaIcon"/></div>
          <div className="ProjectObject"><h1>Project 3</h1><p>Camp Exercise Simulator</p>< img src = {tent} alt="CyclingIcon"/></div>
        </div>
      </div>
