    ...
    <footer className="footer-container">
      <div className="footer-grid">
        ...
        <div className="socials-logo">
          <img src={LinkedinLogo} alt="Redback LinkedIn" /> <p>LinkedIn</p>
        </div>
        <div className="socials-logo">
          <img src={instagramLogo} alt="Redback Instagram" /> <p>Instagram</p>
        </div>
        <div className="socials-logo">
          <img src={twitterLogo} alt="Redback Twitter" /> <p>Twitter</p>
        </div>
      </div>
